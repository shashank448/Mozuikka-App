...
class Model:
    def __init__(self):
        ...
        try:
            self.conn=connect("mouzikka/music@UPLC/xe")
    ...
    def add_song_to_favourites(self,song_name,song_path):
        ...
        print("last song id",next_song_id,type(next_song_id))
    ...
    def load_song_from_favourites(self):
        ...
        for s_name,s_path in song_list:
            self.song_dict[s_name]=s_path
        ...
        if song_present==True:
            ...
            return "No song selected in your favourites"
